    ...
    return (
      <div className="mx-auto max-w-md px-4 py-16 text-center">
        <p className="text-sm text-muted-foreground">
          Invalid reset link. <Link href="/forgot-password" className="text-indigo-600 hover:underline">Request a new one</Link>.
        </p>
      </div>
    )
  }
    ...
    <div className="mx-auto flex max-w-md flex-col px-4 py-16">
      <div className="mb-8 text-center">
        <h1 className="flex items-center justify-center gap-2 text-2xl font-bold tracking-tight">
          <ShieldCheck className="h-6 w-6 text-indigo-500" /> Choose a new password
        </h1>

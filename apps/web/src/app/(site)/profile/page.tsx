...
function ProfileInner() {
  ...
  // Sync the form once per loaded user (not during render).
  useEffect(() => {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-10">
      <div className="mb-6 flex items-center gap-2">
        <User className="h-6 w-6 text-orange-500" aria-hidden />
        ...
        <Card>
          <CardContent className="flex flex-col gap-4 p-5">
            <div className="flex items-center gap-4">
              <span className="flex h-14 w-14 items-center justify-center overflow-hidden rounded-full bg-orange-600 text-xl font-bold text-white">
                {me.avatarUrl ? (
                  // eslint-disable-next-line @next/next/no-img-element -- R2 avatar URLs are same-origin public CDN links

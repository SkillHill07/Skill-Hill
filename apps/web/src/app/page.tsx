    ...
    <div className="overflow-x-clip">
      ...
      <section className="relative mx-auto flex max-w-6xl flex-col items-center gap-6 px-4 pb-16 pt-16 text-center sm:pt-24">
        ...
        >
          ...
          <Button size="lg" variant="outline">
            <Link href="/problems">Practice library</Link>
          </Button>
        </motion.div>
          ...
          >
            <Card>
              <CardContent className="p-5 text-left">
                <Badge tone="violet">Announcement</Badge>
      ...
      <section className="mx-auto max-w-6xl px-4 py-14">
        <div className="mb-8 flex items-end justify-between gap-4">
          ...
          />
          <Button variant="ghost" size="sm" className="mb-1 hidden shrink-0 sm:inline-flex">
            <Link href="/contests" className="flex items-center gap-1">
                ...
                <Link href={`/problems?difficulty=${d.label.toLowerCase()}`} className="group block h-full">
                  <Card className={`h-full border bg-card transition-all duration-200 group-hover:-translate-y-0.5 group-hover:shadow-md ${d.tone}`}>
                    <CardContent className="flex h-full flex-col gap-2 p-5">
                      ...
                      <span className="mt-auto flex items-center gap-1 pt-2 text-sm font-medium text-indigo-600 group-hover:underline dark:text-indigo-400">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16">
        <Reveal>
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 px-6 py-14 text-center text-white sm:px-12">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              ...
              >
                <Link href="/contests" className="flex items-center gap-2">
                  <BrainCircuit className="h-4 w-4" /> View contests
                </Link>
              </Button>
            </div>
          </div>
